...
class Network
{
    ...
    public void Learn(int number)
    {
        ...
        {
            //Console.Clear();
            //Console.WriteLine("Training progress: " + trainingStatus + "/" + trainingLength + "\t" + correctGuess + "/" + inputs.Length + "\t" + BatchTest().ToString("0.00") + "%  " + cost);
            Console.WriteLine("Training progress: " + trainingStatus + "/" + trainingLength + "\t" + BatchTest().ToString("0.00") + "%  (" + cost + ")");
            trainingStatus++;
            Test();

            //Console.WriteLine($"{i + 1}. Cost: {Test()}\t{correctGuess}/{inputs.Length}");
            //Console.ReadKey();
    ...
    float Test()
    {
        ...
        //foreach (float num in outputs[outputs.Length - 1])
        //{
        //    Console.Write(num.ToString("0.0000") + " ");
        //}

        //Console.WriteLine(" -> " + correctNumbers[correctNumbers.Length - 1]  + "   " + cost.ToString("0.000"));
